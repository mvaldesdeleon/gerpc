...
module.exports = function client({host = DEFAULT_HOST, port = DEFAULT_PORT, encode, decode}, credentials) {
    ...
    const client = new grpc.Client(`${host}:${port}`, credentials || insecureCredentials);
